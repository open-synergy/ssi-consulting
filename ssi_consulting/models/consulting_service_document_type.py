...
class ConsultingServiceDocumentType(models.Model):
    _name = "consulting_service.document_type"
    _description = "Consulting Service - Document Type"
    _inherit = [
    ...
    entity_ids = fields.Many2many(
        ...
        relation="consulting_service_document_type_entity_rel",
